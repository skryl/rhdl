...
The `examples/mos6502/` directory contains a complete behavioral simulation of the MOS 6502 microprocessor, including all official instructions, addressing modes, and a two-pass assembler.
