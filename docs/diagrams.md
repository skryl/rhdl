...
- Gate-level diagrams operate directly on `RHDL::Export::Structural::IR`, where nets are integer IDs and inputs/outputs are named buses with arrays of net IDs.
