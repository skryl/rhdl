...
Analog circuits don't map naturally to RHDL's digital model. Instead, see [Appendix R](appendix-r-analog.md) for Ruby simulation of analog components using continuous-time differential equations.
...
*Appendix: [Appendix R - Analog Simulation](appendix-r-analog.md)*
