...
RSpec.describe 'SimCPU vs SimCPUNative benchmark', if: RHDL::Codegen::Structure::NATIVE_SIM_AVAILABLE do
  # Create a moderately complex circuit for benchmarking
  # This simulates a simple ALU-like structure
  def create_alu_ir(width: 8)
    ir = RHDL::Codegen::Structure::IR.new(name: 'alu_bench')
  ...
  def create_register_chain_ir(width: 8, depth: 4)
    ir = RHDL::Codegen::Structure::IR.new(name: 'reg_chain')
  ...
  describe 'combinational logic benchmark' do
    ...
    let(:ruby_sim) { RHDL::Codegen::Structure::SimCPU.new(ir, lanes: 64) }
    let(:native_sim) { RHDL::Codegen::Structure::SimCPUNative.new(ir.to_json, 64) }
  ...
  describe 'HDL component benchmark' do
    it 'benchmarks with real HDL components' do
      ...
      ir = RHDL::Codegen::Structure::Lower.from_components(components, name: 'hdl_bench')
      ruby_sim = RHDL::Codegen::Structure::SimCPU.new(ir, lanes: 64)
      native_sim = RHDL::Codegen::Structure::SimCPUNative.new(ir.to_json, 64)
