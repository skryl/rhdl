...
RSpec.describe RHDL::HDL::ProgramCounter do
  ...
  describe 'synthesis' do
    ...
    it 'generates valid IR' do
      ir = RHDL::HDL::ProgramCounter.to_flat_circt_nodes
    ...
    it 'generates valid CIRCT MLIR' do
      mlir = RHDL::HDL::ProgramCounter.to_circt
      expect(mlir).to include('hw.output')
      expect(mlir).to include('hw.module @program_counter')
    ...
    context 'CIRCT firtool validation', if: HdlToolchain.firtool_available? do
      it 'firtool can compile FIRRTL to Verilog' do
        result = CirctHelper.validate_firrtl_syntax(
          ...
          base_dir: 'tmp/circt_test/program_counter'
        )
  ...
  describe 'gate-level netlist' do
    ...
    let(:ir) { RHDL::Codegen::Netlist::Lower.from_components([component], name: 'pc') }
