...
RSpec.describe RHDL::HDL::RegisterLoad do
  ...
  describe 'synthesis' do
    ...
    it 'generates valid IR' do
      ir = RHDL::HDL::RegisterLoad.to_flat_circt_nodes
    ...
    it 'generates valid CIRCT MLIR' do
      mlir = RHDL::HDL::RegisterLoad.to_circt
      expect(mlir).to include('hw.output')
      expect(mlir).to include('hw.module @register_load')
  ...
  describe 'gate-level netlist' do
    ...
    context 'iverilog simulation', if: HdlToolchain.iverilog_available? do
      it 'matches behavior simulation' do
        test_vectors = []
        behavior = RHDL::HDL::RegisterLoad.new
    ...
    describe 'simulator comparison' do
      it 'all simulators produce matching results' do
        ...
        NetlistHelper.compare_and_validate!(
          ...
          'register_load',
          test_cases,
          base_dir: 'tmp/netlist_comparison/register_load',
          has_clock: true
        )
      end
    end
