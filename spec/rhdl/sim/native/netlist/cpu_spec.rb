...
RSpec.describe RHDL::Sim::Native::Netlist::RubySimulator do
  let(:ir) { RHDL::Codegen::Netlist::IR.new(name: 'test') }
  ...
  describe 'integration with HDL components' do
    ...
    it 'simulates a D flip-flop from HDL' do
      ...
      ir = RHDL::Codegen::Netlist::Lower.from_components([component], name: 'dff_test')
      sim = described_class.new(ir, lanes: 64)
