...
RSpec.describe 'SimCPU vs SimCPUNative benchmark', if: RHDL::Sim::Native::Netlist::INTERPRETER_AVAILABLE do
  ...
  describe 'combinational logic benchmark' do
    ...
    let(:ruby_sim) { RHDL::Sim::Native::Netlist::RubySimulator.new(ir, lanes: 64) }
    let(:native_sim) { RHDL::Sim::Native::Netlist::Interpreter.new(ir.to_json, 64) }
