...
describe RFile8 do
  ...
  let(:rfile) { RFile8.new }

  describe 'zero' do

    it 'zeroes out all registers' do
      expect(rfile.set!(src_addr_a: '000', src_addr_b: '001').outputs).to eq(src_a: '11111111', src_b: '11111111')
      expect(rfile.set!(src_addr_a: '010', src_addr_b: '011').outputs).to eq(src_a: '11111111', src_b: '11111111')
      expect(rfile.set!(src_addr_a: '100', src_addr_b: '101').outputs).to eq(src_a: '11111111', src_b: '11111111')
      expect(rfile.set!(src_addr_a: '110', src_addr_b: '111').outputs).to eq(src_a: '11111111', src_b: '11111111')
