...
RSpec.shared_examples 'xv6 shell UART I/O' do |pipeline:, backend_id:, boot_cycles:, prompt_cycles:, timeout_seconds:|
  ...
  it "boots xv6 shell and executes an echo command over UART (#{backend_id})", :slow, timeout: timeout_seconds do
    case backend_id
    when :jit
...
XV6_SINGLE_BACKEND_CASES = [
  { id: :jit, harness_backend: :jit, boot_cycles: 25_000_000, prompt_cycles: 6_000_000, timeout_seconds: 240 },
  { id: :compiler, harness_backend: :compiler, boot_cycles: 25_000_000, prompt_cycles: 6_000_000, timeout_seconds: 300 },
  { id: :compiler_aot, harness_backend: :compiler, boot_cycles: 25_000_000, prompt_cycles: 6_000_000, timeout_seconds: 300 }
].freeze
