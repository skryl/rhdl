...
require_relative '../../../examples/mos6502s/alu'

RSpec.describe MOS6502S::ALU do
  let(:alu) { MOS6502S::ALU.new }
  ...
  describe 'SBC' do
    it 'subtracts two numbers with borrow clear' do
      ...
      alu.set_input(:op, MOS6502S::ALU::OP_SBC)
      alu.propagate
  ...
  describe 'Logic operations' do
    ...
    it 'performs ORA' do
      alu.set_input(:a, 0xF0)
      alu.set_input(:b, 0x0F)
      alu.set_input(:op, MOS6502S::ALU::OP_ORA)
      alu.propagate
  ...
  describe 'Shift operations' do
    it 'performs ASL' do
      ...
      alu.set_input(:op, MOS6502S::ALU::OP_ASL)
      alu.propagate
    ...
    it 'performs LSR' do
      alu.set_input(:a, 0x81)
      alu.set_input(:op, MOS6502S::ALU::OP_LSR)
      alu.propagate
  ...
  describe 'Compare' do
    it 'compares equal values' do
      ...
      alu.set_input(:op, MOS6502S::ALU::OP_CMP)
      alu.propagate
