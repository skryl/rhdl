...
RSpec.describe RHDL::Examples::MOS6502::InstructionRegister do
  ...
  describe 'gate-level netlist' do
    ...
    let(:netlist_ir) { RHDL::Codegen::Netlist::Lower.from_components([component], name: 'mos6502_instruction_register') }
