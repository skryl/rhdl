import { RUNNER_PRESETS } from '../app_constants.mjs';
import { formatValue } from '../lib/numeric_utils.mjs';
import { waveformFontFamily, waveformPalette } from '../lib/theme_utils.mjs';
import { setupWaveformP5 } from '../components/waveform_panel.mjs';
import { createRegistryLazyGetters } from './registry_controller_lazy_getters.mjs';
import { createShellDomainController } from './registry_shell_domain_controller.mjs';
import { createRunnerDomainController } from './registry_runner_domain_controller.mjs';
import { createComponentDomainController } from './registry_component_domain_controller.mjs';
import { createApple2DomainController } from './registry_apple2_domain_controller.mjs';
import { createSimDomainController } from './registry_sim_domain_controller.mjs';
import { createWatchDomainController } from './registry_watch_domain_controller.mjs';
