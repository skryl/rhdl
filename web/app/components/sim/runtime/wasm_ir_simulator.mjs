...
export class WasmIrSimulator {
  ...
  apple2_load_rom(bytes) {
    ...
    return this.withAllocatedBytes(bytes, (ptr, len) => {
      this.e.apple2_interp_sim_load_rom(this.ctx, ptr, len);
      return true;
    });
  }
  ...
  apple2_load_ram(bytes, offset = 0) {
    ...
    return this.withAllocatedBytes(bytes, (ptr, len) => {
      this.e.apple2_interp_sim_load_ram(this.ctx, ptr, len, Number(offset) >>> 0);
      return true;
    });
  }
  ...
  apple2_read_ram(offset, length) {
    ...
    return this.readBytesViaExport((ctx, off, ptr, len) => this.e.apple2_interp_sim_read_ram(ctx, off, ptr, len), offset, length);
  }

  apple2_read_memory(offset, length) {
    if (!this.hasExport('apple2_interp_sim_read_memory')) {
      return this.apple2_read_ram(offset, length);
    }
    return this.readBytesViaExport((ctx, off, ptr, len) => this.e.apple2_interp_sim_read_memory(ctx, off, ptr, len), offset, length);
  }
  ...
  apple2_write_ram(offset, bytes) {
    ...
    return this.withAllocatedBytes(bytes, (ptr, len) => {
      this.e.apple2_interp_sim_write_ram(this.ctx, Number(offset) >>> 0, ptr, len);
      return true;
    });
  }
}
