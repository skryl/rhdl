...
fn init(ruby: &Ruby) -> Result<(), Error> {
    ...
    class.define_method("mos6502_speaker_toggles", method!(RubyRtlSim::mos6502_speaker_toggles, 0))?;
    class.define_method("reset_mos6502_speaker_toggles", method!(RubyRtlSim::reset_mos6502_speaker_toggles, 0))?;
