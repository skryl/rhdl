...
require_relative 'cli/tasks/import_task'
require_relative 'cli/tasks/gates_task'
require_relative 'cli/tasks/tui_task'
require_relative 'cli/tasks/apple2_task'
require_relative 'cli/tasks/mos6502_task'
require_relative 'cli/tasks/ao486_task'
require_relative 'cli/tasks/deps_task'
require_relative 'cli/tasks/benchmark_task'
require_relative 'cli/tasks/generate_task'
require_relative 'cli/tasks/native_task'
require_relative 'cli/tasks/hygiene_task'
require_relative 'cli/tasks/disk_convert_task'
require_relative 'cli/tasks/web_generate_task'
