...
# Development tasks (spec, setup, parallel, deps, benchmark)
...
namespace :dev do
  namespace :setup do
    ...
    task :binstubs do
      ...
      binstubs_needed.each do |gem_name, executable|
        binstub_path = File.expand_path("bin/#{executable}", RHDL_ROOT)
  ...
  begin
    ...
    def parallel_rspec_cmd
      binstub = File.expand_path('bin/parallel_rspec', RHDL_ROOT)
