# CPU - Self-contained CPU with Internal Control Unit
# All instruction sequencing is handled internally by a state machine.
  ...
  module HDL
    module CPU
      class CPU < Component
        ...
        output :zero_flag_out             # Zero flag register output
