class RFile8 < Rhdl::LogicComponent
  ...
  outputs :src_a, :src_b, bits: 8

  wire :r_sel, :r_en, bits: 8

  wire :r0_data, :r1_data, :r2_data, :r3_data,
       :r4_data, :r5_data, :r6_data, :r7_data, bits: 8
  ...
  logic do
    ...
    Mux8x8(a: r0_data, b: r1_data, c: r2_data, d: r3_data,
