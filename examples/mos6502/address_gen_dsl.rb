...
module MOS6502
  class AddressGenerator_DSL < RHDL::HDL::SimComponent
  ...
  class IndirectAddressCalc_DSL < RHDL::HDL::SimComponent
    port_input :mode, width: 4
    port_input :operand_lo, width: 8
    port_input :operand_hi, width: 8
    port_input :x_reg, width: 8
